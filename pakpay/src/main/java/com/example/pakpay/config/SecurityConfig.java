...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOriginPatterns(Arrays.asList("http://localhost:[*]","https://pakpay-reactjs.vercel.app","https://pakpay-reactjs-pynjpcinh-ihsaan-20s-projects.vercel.app")); 
